document.addEventListener("DOMContentLoaded", (event) => {
    ...
    // banner slider
    const bannerAddressSliderEl = document.querySelector(".ul-banner-address-slider");
    let bannerAddressSlider;
    if (bannerAddressSliderEl) {
        bannerAddressSlider = new Swiper(bannerAddressSliderEl, {
            slidesPerView: 1,
            loop: true,
            autoplay: true,
        });
    ...
    const bannerSliderEl = document.querySelector(".ul-banner-slider");
    if (bannerSliderEl) {
        new Swiper(bannerSliderEl, {
        slidesPerView: 1,
        loop: true,
        // autoplay: true,
        spaceBetween: 0,
    ...
    // banner image slider
    const bannerImgSliderEl = document.querySelector(".ul-banner-img-slider");
    let bannerImgSlider;
    if (bannerImgSliderEl) {
        bannerImgSlider = new Swiper(bannerImgSliderEl, {
        slidesPerView: 1,
        loop: true,
        autoplay: true,
        effect: "fade",
    ...
    // banner txt slider
    const bannerTxtSliderEl = document.querySelector(".ul-banner-txt-slider");
    if (bannerTxtSliderEl) {
        new Swiper(bannerTxtSliderEl, {
        slidesPerView: 1,
        loop: true,
        autoplay: true,
        spaceBetween: 0,
    ...
    // testimonial slider
    if (document.querySelector(".ul-testimonial-slider")) {
    ...
    if (document.querySelector(".ul-partners-slider")) {
    ...
    // blogs slider
    if (document.querySelector(".ul-blogs-slider")) {
    ...
    // ------------------------------- Index 2 js -------------------------------
    // banner slider
    const bannerThumbSliderEl = document.querySelector(".ul-banner-2-thumb-slider");
    let bannerThumbSlider;
    if (bannerThumbSliderEl) {
        bannerThumbSlider = new Swiper(bannerThumbSliderEl, {
        slidesPerView: 3,
        spaceBetween: 10,
    ...
    const bannerSlider2El = document.querySelector(".ul-banner-2-slider");
    if (bannerSlider2El) {
        new Swiper(bannerSlider2El, {
        slidesPerView: 1,
        loop: true,
        autoplay: true,
        spaceBetween: 0,
